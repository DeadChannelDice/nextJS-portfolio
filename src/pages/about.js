                ...
                <div className='grid w-full grid-cols-8 gap-16'>
                    ...
                    <div className='col-span-2 flex flex-col items-end justify-between'>
                        <div className='flex flex-col items-end justify-center'>
                            ...
                            <h2 className='text-xl font-medium capitalize text-dark/75 text-right dark:text-light'>satisfied clients</h2>
                        </div>
                        <div className='flex flex-col items-end justify-center'>
                            <span className='inline-block text-7xl font-bold '>
                                <AnimatedNumbers value={40}/>+
                            </span>
                            <h2 className='text-xl font-medium capitalize text-dark/75 text-right dark:text-light'>projects completed</h2>
                        </div>
                        <div className='flex flex-col items-end justify-center'>
                            <span className='inline-block text-7xl font-bold '>
                                <AnimatedNumbers value={4}/>+
                            </span>
                            <h2 className='text-xl font-medium capitalize text-dark/75 text-right dark:text-light'>years of experience</h2>
                        </div>
                    </div>
                </div>
                <Skills/>
