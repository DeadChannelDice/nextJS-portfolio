        ...
        <div ref={ref} className='w-[75%] mx-auto relative xs:w-full'>
            ...
            <ul className='w-full flex flex-col items-start justify-between ml-4'>
                <Details
                    ...
                    time={"2022 - current"}
                    address={"Brooklyn, NY"}
                    work={"Lead the development of tailored software solutions, transforming client visions into innovative digital products. By combining technical expertise with a deep understanding of user needs, I aspire to consistently deliver impactful results that exceed client expectations"}
               />
               <Details
